...
} else throw `*[❗𝐈𝐍𝐅𝐎❗] RESPONDE A UN VIDEO, 𝙸𝙼𝙰𝙶𝙴𝙽 O INSERTE ENLACE DE UNA IMAGEN TERMINACION .𝚓𝚙𝚐 EL CUAL SERA CONVERTIDO EN STICKER, DEBE RESPONDER ${usedPrefix + command}*`
} catch {
try {
