...
!global.support.gm) {
if (!m.quoted) throw `*[❗𝐈𝐍𝐅𝐎❗] RESPONDA AL STICKER QUE DESEE CONVERIT EN IMAGEN ${usedPrefix + command}*`
let mime = m.quoted.mimetype || ''
if (!/webp/.test(mime)) throw `*[❗𝐈𝐍𝐅𝐎❗] RESPONDA AL STICKER QUE DESEE CONVERIT EN IMAGEN ${usedPrefix + command}*`
